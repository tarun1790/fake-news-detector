document.addEventListener('DOMContentLoaded', () => {
    ...
    function getApiUrl(endpoint) {
        ...
        const defaultBase = window.location.origin.includes('localhost') || window.location.origin.includes('127.0.0.1') ? '' : 'https://loud-seahorse-3.loca.lt';
    ...
    if (settingBackendUrl) {
        settingBackendUrl.value = localStorage.getItem('luffy_backend_url') || 'https://loud-seahorse-3.loca.lt';
    }
